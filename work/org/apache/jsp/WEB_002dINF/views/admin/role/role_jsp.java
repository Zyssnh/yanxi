 ...
 * Generated at: 2018-03-22 08:22:40 UTC
...
public final class role_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    var roleDataGrid;\n");
      out.write("    $(function() {\n");
      out.write("        roleDataGrid = $('#roleDataGrid').datagrid({\n");
      out.write("            url : '");
      ...
      out.write("                $('.role-easyui-linkbutton-ok').linkbutton({text:'授权'});\n");
      out.write("                $('.role-easyui-linkbutton-edit').linkbutton({text:'编辑'});\n");
      out.write("                $('.role-easyui-linkbutton-del').linkbutton({text:'删除'});\n");
      out.write("            },\n");
      out.write("            toolbar : '#roleToolbar'\n");
      out.write("        });\n");
      out.write("    });\n");
      out.write("\n");
      out.write("    function addRoleFun() {\n");
      ...
      out.write("            href : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/addPage',\n");
      out.write("            buttons : [ {\n");
      out.write("                text : '确定',\n");
      out.write("                handler : function() {\n");
      out.write("                    parent.$.modalDialog.openner_dataGrid = roleDataGrid;//因为添加成功之后，需要刷新这个treeGrid，所以先预定义好\n");
      out.write("                    var f = parent.$.modalDialog.handler.find('#roleAddForm');\n");
      out.write("                    f.submit();\n");
      out.write("                }\n");
      out.write("            } ]\n");
      out.write("        });\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function editRoleFun(id) {\n");
      out.write("        if (id == undefined) {\n");
      out.write("            var rows = roleDataGrid.datagrid('getSelections');\n");
      out.write("            id = rows[0].id;\n");
      out.write("        } else {\n");
      out.write("            roleDataGrid.datagrid('unselectAll').datagrid('uncheckAll');\n");
      out.write("        }\n");
      out.write("        parent.$.modalDialog({\n");
      out.write("            title : '编辑',\n");
      out.write("            width : 500,\n");
      ...
      out.write("            href : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/editPage?id=' + id,\n");
      out.write("            buttons : [ {\n");
      out.write("                text : '确定',\n");
      out.write("                handler : function() {\n");
      out.write("                    parent.$.modalDialog.openner_dataGrid = roleDataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好\n");
      out.write("                    var f = parent.$.modalDialog.handler.find('#roleEditForm');\n");
      out.write("                    f.submit();\n");
      out.write("                }\n");
      out.write("            } ]\n");
      out.write("        });\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function deleteRoleFun(id) {\n");
      ...
      out.write("            roleDataGrid.datagrid('unselectAll').datagrid('uncheckAll');\n");
      out.write("        }\n");
      out.write("        parent.$.messager.confirm('询问', '您是否要删除当前角色？', function(b) {\n");
      out.write("            if (b) {\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    function grantRoleFun(id) {\n");
      out.write("        if (id == undefined) {\n");
      out.write("            var rows = roleDataGrid.datagrid('getSelections');\n");
      out.write("            id = rows[0].id;\n");
      out.write("        } else {\n");
      ...
      out.write("            href : '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${path }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/role/grantPage?id=' + id,\n");
      out.write("            buttons : [ {\n");
      out.write("                text : '确定',\n");
      out.write("                handler : function() {\n");
      out.write("                    parent.$.modalDialog.openner_dataGrid = roleDataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好\n");
      out.write("                    var f = parent.$.modalDialog.handler.find('#roleGrantForm');\n");
      out.write("                    f.submit();\n");
      out.write("                }\n");
      out.write("            } ]\n");
      out.write("        });\n");
      ...
      out.write("        <table id=\"roleDataGrid\" data-options=\"fit:true,border:false\"></table>\n");
      out.write("    </div>\n");
      out.write("</div>\n");
      out.write("<div id=\"roleToolbar\" style=\"display: none;\">\n");
      out.write("    ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/admin/role/role.jsp(55,24) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f0.setName("/role/grant");
    int _jspx_eval_shiro_005fhasPermission_005f0 = _jspx_th_shiro_005fhasPermission_005f0.doStartTag();
    if (_jspx_eval_shiro_005fhasPermission_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                            str += $.formatString('<a href=\"javascript:void(0)\" class=\"role-easyui-linkbutton-ok\" data-options=\"plain:true,iconCls:\\'glyphicon-ok icon-green\\'\" onclick=\"grantRoleFun(\\'{0}\\');\" >授权</a>', row.id);\n");
        out.write("                        ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/admin/role/role.jsp(58,24) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';\n");
        out.write("                            str += $.formatString('<a href=\"javascript:void(0)\" class=\"role-easyui-linkbutton-edit\" data-options=\"plain:true,iconCls:\\'glyphicon-pencil icon-blue\\'\" onclick=\"editRoleFun(\\'{0}\\');\" >编辑</a>', row.id);\n");
        out.write("                        ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/admin/role/role.jsp(62,24) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                            str += '&nbsp;&nbsp;|&nbsp;&nbsp;';\n");
        out.write("                            str += $.formatString('<a href=\"javascript:void(0)\" class=\"role-easyui-linkbutton-del\" data-options=\"plain:true,iconCls:\\'glyphicon-trash icon-red\\'\" onclick=\"deleteRoleFun(\\'{0}\\');\" >删除</a>', row.id);\n");
        out.write("                        ");
  ...
  private boolean _jspx_meth_shiro_005fhasPermission_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/admin/role/role.jsp(171,4) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_shiro_005fhasPermission_005f3.setName("/role/add");
    ...
    if (_jspx_eval_shiro_005fhasPermission_005f3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("<a onclick=\"addRoleFun();\" href=\"javascript:void(0);\" class=\"easyui-linkbutton\" data-options=\"plain:true,iconCls:'glyphicon-plus icon-green'\">添加</a>\n");
        out.write("    ");
